...
<body>
    ...
    <div class="containerReport">
            ...
            <form action="">
                ...
                <label for="nombre"></label>
                <input type="text" id="nombre" placeholder="Apellido paterno">
                <label for="nombre"></label>
                <input type="text" id="nombre" placeholder="Apellido Materno">
                <label for="nombre"></label>
                <input type="text" id="nombre" placeholder="Telefono1">
                <label for="nombre"></label>
                <input type="text" id="nombre" placeholder="Telefono2">
                <label for="nombre"></label>
                <input type="text" id="nombre" placeholder="Nombre">
                <label for="nombre"></label>
                <input type="text" id="nombre" placeholder="Segundo nombre">
